...
Der PR enthält PAT Sans 0.3 und PAT Serif 0.4. Die Serif wurde nach dem Alphabet- und Abstandsvergleich weiter bearbeitet: Mittelspitze von W/w, deutsche Zeichen, einzelne Abschlüsse, Breiten und Kerning. Die Sans bleibt gegenüber Version 0.3 unverändert. Dieser Bericht trennt lokale Prüfung und Buildabschluss von noch nicht verifizierten privaten Dienstanbindungen.
...
- Produktionsbuild `cwGracvikk_STlVg5kXMU` erfolgreich abgeschlossen, einschließlich TypeScript.
...
| --- | ---: | ---: | ---: |
| Übersicht | 631.128 B | 182.613 B | 20 |
| Modulübersicht | 657.273 B | 192.215 B | 23 |
| Lektion | 645.398 B | 187.354 B | 22 |
| Indikatoren | 813.806 B | 234.061 B | 24 |

Die zwölf Fontdateien umfassen zusammen 774.536 Bytes. Sie sind nicht Teil dieser JavaScript-Zahlen. `preload: false` lädt nur die tatsächlich verwendeten Schnitte; alle zwölf Dateien wurden anhand ihrer Prüfsummen im Produktionsbuild nachgewiesen.
