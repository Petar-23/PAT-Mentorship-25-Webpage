        ...
        {isActivated ? (
          ...
          >
            ...
            <span className="pointer-events-none absolute inset-0 flex items-center justify-center">
              <span className="inline-flex h-14 w-14 translate-y-[30%] items-center justify-center rounded-full border border-white/35 bg-slate-900/45 text-white shadow-md backdrop-blur-[1px] transition-transform group-hover:scale-105 sm:h-16 sm:w-16">
