...
test('research code never imports mentorship client modules (icon barrel, navigation link, shell)', () => {
  const offenders = [...listFiles('app/research/'), ...listFiles('components/research/')]
    .filter((file) => /from ['"]@\/components\/mentorship\/(icons|navigation-link|shell)['"]/.test(read(file)))
