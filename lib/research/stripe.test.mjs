...
test('setup script: argument parsing', () => {
  // Webhook/Vercel-Optionen: siehe scripts/research-stripe-setup.test.mjs.
  const defaults = {
    webhookUrl: null,
    rotateWebhook: false,
    vercelBranch: null,
    vercelProject: 'pat-mentorship-25-webpage',
    vercelScope: 'petar23s-projects',
  }
  assert.deepEqual(parseSetupArgs([]), { apply: false, live: false, liveApproval: false, help: false, termsUrl: null, privacyUrl: null, ...defaults })
