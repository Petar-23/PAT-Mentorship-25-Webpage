...
// Env-Var-Namen der sechs Stripe-Preise (Produkt "PAT Research", USD).
...
export const RESEARCH_PORTAL_CONFIGURATION_ENV = 'STRIPE_RESEARCH_PORTAL_CONFIGURATION_ID'

// Stripe-Produkt "PAT Research". Dient als Fallback beim Zuordnen von Preisen
// (price.metadata.research_tier/_interval), falls Preise später rotiert werden.
export const RESEARCH_PRODUCT_ID_ENV = 'STRIPE_RESEARCH_PRODUCT_ID'
