...
See [MENTORSHIP_FONTS.md](../../docs/MENTORSHIP_FONTS.md) for design changes, licence, scope and verification. Current versions: PAT Sans 0.3 and PAT Serif 0.4.

Download only the four fonts and two licence files listed in source-manifest.json into a separate SOURCE_ROOT, preserving the relative paths. Copy the manifest to SOURCE_ROOT/source-manifest.json. With Python, fontTools[woff] and uharfbuzz available, run:
