...
export const config = {
  matcher: [
    ...
    // Videos (Range-Anfragen) und AVIF ebenfalls ohne Middleware ausliefern.
    '/((?!_next|[^?]*\\.(?:html?|css|js(?!on)|jpe?g|webp|avif|png|gif|svg|ttf|woff2?|ico|csv|docx?|xlsx?|zip|webmanifest|mp4|webm)).*)',
