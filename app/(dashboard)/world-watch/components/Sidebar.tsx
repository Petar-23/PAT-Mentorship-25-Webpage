...
function StatBadge({ label, count, color, theme }: StatBadgeProps) {
  return (
    <div style={{
      ...
      <span style={{ fontSize: 9, color: theme.overlay0, letterSpacing: '1px' }}>{label}</span>
    </div>
  );
}
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ fontSize: 10, fontWeight: 700, color: theme.subtext0, letterSpacing: '2px', marginBottom: 8 }}>
          EVENT FEED
        </div>
