      ...
      <Card className="max-w-3xl mx-auto bg-white">
        <div className="p-6 md:p-8">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600 mb-4">
              Der Anbieter erbringt ausschließlich edukative Leistungen zur Vermittlung von Trading-Wissen. Keine Anlageberatung i.S.d. KWG/WpHG. Aufzeichnungen werden auf Whop hochgeladen, um sie den Kunden verfügbar zu machen.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <ol className="list-decimal pl-6 space-y-2 text-gray-600">
              <li>Der Vertrag kommt über die Stripe-Checkout-Funktion auf der Website des Anbieters oder durch Annahme einer individuellen Rechnung zustande.</li>
              <li>Die auf der Website angezeigten Preise sind Nettopreise (zzgl. jeweils gültiger gesetzlicher Umsatzsteuer). Die jeweilige Umsatzsteuer und der Gesamtpreis (brutto) werden im Checkout transparent ausgewiesen und vor Abschluss der Bestellung nochmals deutlich angezeigt.</li>
              <li>Mit Abschluss des Checkouts erklärt sich der Kunde mit dem ausgewiesenen Gesamtpreis einverstanden.</li>
            </ol>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600 mb-4">
              Zahlung erfolgt direkt über Stripe (Kreditkarte oder SEPA). Bei individuellen 1:1-Mentorings kann auch per Rechnung mit Banküberweisung gezahlt werden.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-600">
              ...
              <li>Kündigung über die Stripe-Customer-Portal-Funktion oder per E-Mail an kontakt@price-action-trader.de</li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            <ol className="list-decimal pl-6 space-y-2 text-gray-600">
              <li>Verbraucher haben ein 14-tägiges Widerrufsrecht (§§ 355 ff. BGB). Die detaillierte Widerrufsbelehrung ist vor Vertragsschluss auf price-action-trader.de/widerruf abrufbar und wird per E-Mail nach Kauf zugesandt.</li>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600 mb-4">
              Die Verarbeitung personenbezogener Daten erfolgt nach Maßgabe der Datenschutzerklärung, abrufbar unter [deine-website.de/datenschutz].
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600 mb-4">
              Deutsches Recht | Gerichtsstand für Kaufleute: Sitz des Anbieters | OS-Plattform: https://ec.europa.eu/odr | Salvatorische Klausel.
            </p>
          </section>
