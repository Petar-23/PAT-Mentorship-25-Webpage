...
export default async function DiscordPage({
  ...
  return (
    <div className="m-workspace">
      <div className="m-desktop-sidebar hidden xl:block"><Sidebar kurse={kurseForSidebar} pages={pagesForSidebar} savedSidebarOrder={savedSidebarOrder} isAdmin={isAdmin} /></div>
